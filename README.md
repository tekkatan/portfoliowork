...
### Info
- A small simple program which searches a Dutch IBAN in a String or a File.
- Contains a method for conversing a relative filepath into an absolute filepath.
